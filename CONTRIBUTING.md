# Contributing to oktopus

Thanks for your interest in contributing to oktopus.

## Submitting Bug Reports

Please use the [GitHub issue tracker](https://github.com/kartverket/oktopus/issues). Before creating a new issue, do a quick search to see if the problem has been reported already.
